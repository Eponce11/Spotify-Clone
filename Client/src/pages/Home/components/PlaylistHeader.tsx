...
const PlaylistHeader = (props: PlaylistHeaderProps) => {
  ...
  return <section className="bg-[rgb(32,87,100)] w-full pb-5 flex pt-20 px-6 bg-gradient-to-b from-[#487797] to-[#0e6b91dc]">
  <img src={playlist.playlistUrl} alt="album img" className="w-[232px] aspect-square rounded-md"/>
